...
export default function HomePage() {
  return (
    <div className="max-w-lg mx-auto h-[100vh]">
      <div className="flex flex-col justify-center items-center lg:hidden h-[100vh]">
        ...
        <section className="my-20">
          ...
          <div className="flex flex-col gap-8">
            ...
            <ul className="text-purple-900 font-medium space-y-3">
              <li title="🔥">🔹 Learning through Visualization</li>
